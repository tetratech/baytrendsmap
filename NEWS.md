...
-   docs: DESCRIPTION, require version of shiny prior to v1.6.0
    -   shiny v1.6.0 breaks code in baytrendsmap
-   refactor: Server, reinstate columnDefs
-   fix: Add script in data-raw for installing previous versions of
    packages
    -   shiny 1.5.0

# baytrendsmap 1.2.1.8001

Released - 2021-12-07

-   refactor: Update app for 2020 data, Issue \#55
    -   Use dev\_data2020 branch
    -   Use 8000 series for versioning
-   refactor: Update data files for 2020 collection data
    -   data-raw\_ShinyDataFinal\_2020.R
    -   rename existing process file to
        ProcessData\_ShinyDataFinal\_2019.R
-   refactor: Update Shiny app for 2020 data names
    -   global.R
        -   Change names of “final” data files to use new 2020 data
    -   server.R modification for 2020
        -   Remove columnDefs from import and filtered data tables (was
            failing)
