...
* fix: Add script in data-raw for installing previous versions of packages
    + shiny 1.5.0
...
* refactor: Update app for 2020 data, Issue #55
    + Use dev_data2020 branch
    + Use 8000 series for versioning
* refactor: Update data files for 2020 collection data
    + data-raw\ProcessData_ShinyDataFinal_2020.R
    + rename existing process file to ProcessData_ShinyDataFinal_2019.R
* refactor: Update Shiny app for 2020 data names
    ...
    + server.R modification for 2020
        - Remove columnDefs from import and filtered data tables (was failing)
...
* Unwind change to DESCRIPTION URL and packageVersion() in global.R.
    + Unable to get Shinyapps.io to use the development branch when installing.
...
* Modify file import to be able to use base files saved in-app; Issue #19
    + Remaining issue of if select upload cannot select 'official' file from radio buttons.
