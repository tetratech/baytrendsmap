...
* refactor: Update global baytrends_files reference for file re-organization
...
* fix: Use consistent terminology in all locations for Long Term, Issue #67
...
* refactor: Update remote file directory structure, Issue #54 and Issue #50
...
* feat: Added plot creation script for "no data" in Shiny leaflet map pop up, 
Issue #49
...
* feat: Update Shiny app to auto update data import pick list from saved table,
Issue #54
...
* fix: Update range map in Shiny to use all categories when user supplies custom
classes, Issue #51
* docs: Update README to use `remotes` instead of `devtools` in install example
