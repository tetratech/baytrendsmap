...
1. In R studio, run these 3 lines to open up the shiny app:
...
2. Once open, in tab "1. Import Data"" browse to the your desired `baytrends` package output.

3. Be sure data loaded into the screen after you import.
